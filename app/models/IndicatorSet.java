...
public class IndicatorSet extends RdfModel {
    ...
    public static Model.Finder<Long,IndicatorSet> find = new Model.Finder(
            Long.class, IndicatorSet.class
    );

    public static List<IndicatorSet> all() {
        return find.all();
    }

    public static void create(IndicatorSet indicatorSet) {
        indicatorSet.save();
    }

    public static void update(IndicatorSet indicatorSet) {
        indicatorSet.save();
    }
