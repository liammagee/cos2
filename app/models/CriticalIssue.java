...
public class CriticalIssue extends RdfModel {
    ...
    public static Model.Finder<Long,CriticalIssue> find = new Model.Finder(
            Long.class, CriticalIssue.class
    );

    public static List<CriticalIssue> all() {
        return find.all();
    }

    public static void create(CriticalIssue issue) {
        issue.save();
    }

    public static void update(CriticalIssue issue) {
        issue.save();
    }
